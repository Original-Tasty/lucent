/* src/config/lucent-config.h.  Generated from lucent-config.h.in by configure.  */
/* src/config/lucent-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef LUCENT_CONFIG_H

#define LUCENT_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Lucent Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Lucent Core"
...
#define PACKAGE_BUGREPORT "https://github.com/LucentCoin/Lucent/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Lucent Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Lucent Core 0.13.0.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "lucentcore"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://lucentgold.com/"
